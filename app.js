...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + add + '.';
  var productMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product + '.';

  return [add, product, sumMessage, productMessage];
}
...
function sumArray(testArray){ //eslint-disable-line
  var sumArray = testArray[0];
  for (var i = 1; i < testArray.length; i++)
  {
    sumArray = sum(sumArray, testArray[i])[0];
  }

  return [sumArray, testArray + ' was passed in as an array of numbers, and ' + sumArray + ' is their sum.'];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var productArray = testArray[0];
  for (var i = 1; i < testArray.length; i++)
  {
    productArray = multiply(productArray, testArray[i])[0];
  }

  return [productArray, 'The numbers ' + testArray + ' have a product of ' + productArray + '.'];
}
